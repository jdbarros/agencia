...
import ButtonDuvida from 'components/buttonDuvida';

const CustomerSupport = () => {
  return (
    <Box as="section" sx={styles.customerSupport} data-aos="flip-right">
      <Container>
        <Grid sx={styles.row}>
          <Box sx={styles.col}>
            <Box sx={styles.content}>
              <Heading as="h3">
              Quer integrar o seu site com suas redes socias?
              </Heading>
              <Text as="p">
              Aqui também é o seu lugar.
              </Text>
              <Text as="p" sx={styles.specialText}>
              Se o cliente entrar no seu site, ele poderá ser direcionado para suas redes sociais - WhatsApp, Instagram, Facebook ou qualquer outra página.
              </Text>
              <ButtonDuvida />
            </Box>
          </Box>
