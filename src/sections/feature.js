...
const FeatureData = [
  {
    image: featureImage1,
    title: 'Quero uma página de vendas',
    comments: '22 Comments',
    path: 'https://startup-app-modern.vercel.app',
  },
  {
    image: featureImage2,
    title: 'Quero um site para minha empresa',
    comments: '15 Comments',
    path: 'https://startup-agency.vercel.app/',
  },
  {
    image: featureImage3,
    title:
    ...
    path: 'https://startup-online-course.vercel.app',
  },
];
...
const Feature = () => {
  ...
  return (
    <Box sx={styles.features} id="news" >
      <Container>
        <BlockTitle
          slogan="Escolha o seu Layout"
          title="Veja alguns modelos de site que você pode escolher:"
