...
const BoostAgencies = () => {
  return (
    <Box sx={styles.boostAgencies} data-aos="fade-down-right">
      <Container>
        <Box sx={styles.row}>
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                Quais os benefícios de construir o seu site conosco?
                </Heading>
                <Text as="p">
                O site será construído baseado em performace, experiência do usuário e com as mellhores tecnologias da atualidade.
                </Text>
              </Box>
